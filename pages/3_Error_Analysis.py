...
# Load pickled V1 error analysis DF
with open('pickles/v1_ea_df.pkl', 'rb') as f:
    v1_ea_df = pickle.load(f)

# Load pickled V2 error analysis DF
...
**Most misclassified:**
- **Persuasion** (Jane Austen) — 47 chunks — one of Austen's most atypical novels, with a more melancholic and lyrical tone than her others
...
**Most misclassified:**
- **Belinda** (Maria Edgeworth) — 50 chunks — unsurprising given Edgeworth was a direct influence on Austen, and their domestic social fiction share many stylistic features
- **Persuasion** (Jane Austen) — 48 chunks — consistently the hardest Austen novel for the model across both versions
